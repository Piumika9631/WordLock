package com.teamphonix.wordlock.base;
...
public class AppConstants {
    ...
    public static final String SHARED_PREFERENCE_LOGGED_USER = "logged_user"; //boolean
    public static final String SHARED_PREFERENCE_REGISTERED_USER = "registered_user"; //boolean
